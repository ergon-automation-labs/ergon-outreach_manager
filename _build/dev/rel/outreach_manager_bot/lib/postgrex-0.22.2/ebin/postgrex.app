{application,postgrex,
             [{config_mtime,1782496606},
              ...
              {modules,['Elixir.Collectable.Postgrex.Stream',
                        ...
                        'Elixir.DBConnection.Query.Postgrex.TextQuery',
                        ...
                        'Elixir.String.Chars.Postgrex.TextQuery']},
              {registered,[]},
              {vsn,"0.22.2"},
              {mod,{'Elixir.Postgrex.App',[]}},
              {env,[{type_server_reap_after,180000},
                    {type_server_timeout,60000},
