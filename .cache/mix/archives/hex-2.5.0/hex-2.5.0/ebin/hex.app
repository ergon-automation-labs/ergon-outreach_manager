{application,hex,
             [{optional_applications,[]},
              ...
              {modules,['Elixir.Hex','Elixir.Hex.API.Auth',
                        ...
                        'Elixir.Hex.Application','Elixir.Hex.Auth',
                        'Elixir.Hex.Config','Elixir.Hex.Cooldown',
                        ...
                        'Elixir.Hex.OAuth','Elixir.Hex.Package',
                        'Elixir.Hex.Parallel','Elixir.Hex.Policy',
                        'Elixir.Hex.Policy.Diagnostics',
                        'Elixir.Hex.Policy.Filter',
                        'Elixir.Hex.Registry.Cooldown',
                        'Elixir.Hex.Registry.Policy',
                        ...
                        'Elixir.String.Chars.Hex.Solver.Term',
                        mix_hex_advisory,mix_hex_api,mix_hex_api_auth,
                        mix_hex_api_key,mix_hex_api_oauth,
                        mix_hex_api_organization,
                        mix_hex_api_organization_member,mix_hex_api_package,
                        mix_hex_api_package_owner,mix_hex_api_release,
                        mix_hex_api_short_url,mix_hex_api_user,
                        mix_hex_cli_auth,mix_hex_core,mix_hex_erl_tar,
                        mix_hex_http,mix_hex_http_httpc,mix_hex_licenses,
                        mix_hex_pb_names,mix_hex_pb_package,mix_hex_pb_policy,
                        mix_hex_pb_signed,mix_hex_pb_versions,
                        mix_hex_registry,mix_hex_repo,
