defmodule BotArmyOutreachManager.Skills.Example do
  @moduledoc """
  Example skill for Outreach Manager Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_outreach_manager.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_outreach_manager.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_outreach_manager/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_outreach_manager.command.example"
    ]
  end
