defmodule BotArmyOutreachManager.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Outreach Manager Bot.
  ...
  2. **`bot.outreach_manager.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "outreach_manager"
  @envelope_source "bot_army_outreach_manager"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Outreach Manager Bot pulse publisher")
