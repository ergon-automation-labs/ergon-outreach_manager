defmodule BotArmyOutreachManager.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyOutreachManager.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_outreach_manager.command.example" in triggers
    end
  end
